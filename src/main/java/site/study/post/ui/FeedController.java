...
public class FeedController {
    ...
    public Response<List<GetPostContentResponseDto>> getPostFeedList(
        ...
        @RequestBody GetPostFeedListRequestDto dto
    ) {
        List<GetPostContentResponseDto> contentResponse = userPostQueueQueryRepository.getContentResponse(userId, dto.lastContentId());
